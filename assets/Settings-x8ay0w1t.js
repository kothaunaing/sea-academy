import{o as ge,n as rn,p as on,a4 as sn,q as an,k as ce,a5 as fe,r as I,v as un,_ as cn,z as ln,i as dn,j as d,x as Je,y as hn,a6 as Pe,a7 as c,a8 as y,a9 as A,aa as l,ab as _,ac as Se,ad as Ne,ae as Ae,af as Oe,ag as $e,ah as Ye,ai as Xe,aj as kt,ak as fn,al as pn,am as vn,an as mn,ao as O,ap as Ie,aq as gn,ar as In,as as yn,at as oe,au as se,A as Le,E as R,G as P,F as W,H as K,av as _n,aw as Tn,ax as wn,h as En,b as Qe,J as Ze,d as et,ay as kn,u as Cn,R as bn,az as re,I as Rn,aA as Pn,aB as Sn,aC as Nn,aD as An}from"./index-bR4MaZOJ.js";import{L as On}from"./LoadingScreen-yCIU47i-.js";import{P as Ln}from"./ProfilePicture-NkVAKawu.js";import{i as Un}from"./browser-image-compression-9kymdGFS.js";import{L as tt,S as xn,T as Ce}from"./TextField-lZjHCUEq.js";import{C as Mn}from"./ConfirmDelete-c9kJHvBT.js";import{D as Ct}from"./Dialog-pOjzfPCd.js";import{S as Y}from"./Stack-WYlN-LHL.js";import{T as Te}from"./Tooltip-jKN6Sqwz.js";import{S as N}from"./Skeleton-LRfmB9RD.js";import{I as nt}from"./IconButton-zFeYIEAO.js";import{E as Dn}from"./EditSharp-tls7Gpwf.js";import{C as Fn}from"./ContentCopySharp-0frtFtlg.js";import{L as Vn}from"./LogoutSharp-pxfmH8Gp.js";import{U as jn}from"./UpdateSharp-SdzBUA14.js";import"./Portal-vj8E7tuN.js";import"./Modal-AMyV4m0Z.js";import"./debounce-gOEKrWSg.js";import"./useControlled-Tg6WpoLH.js";import"./createSvgIcon-3G1Z23-M.js";const Hn=ge("MuiDivider",["root","absolute","fullWidth","inset","middle","flexItem","light","vertical","withChildren","withChildrenVertical","textAlignRight","textAlignLeft","wrapper","wrapperVertical"]),rt=Hn,qn=ge("MuiListItemIcon",["root","alignItemsFlexStart"]),it=qn,Gn=ge("MuiListItemText",["root","multiline","dense","inset","primary","secondary"]),ot=Gn;function zn(n){return rn("MuiMenuItem",n)}const Wn=ge("MuiMenuItem",["root","focusVisible","dense","disabled","divider","gutters","selected"]),ie=Wn,Kn=["autoFocus","component","dense","divider","disableGutters","focusVisibleClassName","role","tabIndex","className"],Bn=(n,e)=>{const{ownerState:t}=n;return[e.root,t.dense&&e.dense,t.divider&&e.divider,!t.disableGutters&&e.gutters]},Jn=n=>{const{disabled:e,dense:t,divider:r,disableGutters:i,selected:o,classes:s}=n,u=hn({root:["root",t&&"dense",e&&"disabled",!i&&"gutters",r&&"divider",o&&"selected"]},zn,s);return ce({},s,u)},$n=on(sn,{shouldForwardProp:n=>an(n)||n==="classes",name:"MuiMenuItem",slot:"Root",overridesResolver:Bn})(({theme:n,ownerState:e})=>ce({},n.typography.body1,{display:"flex",justifyContent:"flex-start",alignItems:"center",position:"relative",textDecoration:"none",minHeight:48,paddingTop:6,paddingBottom:6,boxSizing:"border-box",whiteSpace:"nowrap"},!e.disableGutters&&{paddingLeft:16,paddingRight:16},e.divider&&{borderBottom:`1px solid ${(n.vars||n).palette.divider}`,backgroundClip:"padding-box"},{"&:hover":{textDecoration:"none",backgroundColor:(n.vars||n).palette.action.hover,"@media (hover: none)":{backgroundColor:"transparent"}},[`&.${ie.selected}`]:{backgroundColor:n.vars?`rgba(${n.vars.palette.primary.mainChannel} / ${n.vars.palette.action.selectedOpacity})`:fe(n.palette.primary.main,n.palette.action.selectedOpacity),[`&.${ie.focusVisible}`]:{backgroundColor:n.vars?`rgba(${n.vars.palette.primary.mainChannel} / calc(${n.vars.palette.action.selectedOpacity} + ${n.vars.palette.action.focusOpacity}))`:fe(n.palette.primary.main,n.palette.action.selectedOpacity+n.palette.action.focusOpacity)}},[`&.${ie.selected}:hover`]:{backgroundColor:n.vars?`rgba(${n.vars.palette.primary.mainChannel} / calc(${n.vars.palette.action.selectedOpacity} + ${n.vars.palette.action.hoverOpacity}))`:fe(n.palette.primary.main,n.palette.action.selectedOpacity+n.palette.action.hoverOpacity),"@media (hover: none)":{backgroundColor:n.vars?`rgba(${n.vars.palette.primary.mainChannel} / ${n.vars.palette.action.selectedOpacity})`:fe(n.palette.primary.main,n.palette.action.selectedOpacity)}},[`&.${ie.focusVisible}`]:{backgroundColor:(n.vars||n).palette.action.focus},[`&.${ie.disabled}`]:{opacity:(n.vars||n).palette.action.disabledOpacity},[`& + .${rt.root}`]:{marginTop:n.spacing(1),marginBottom:n.spacing(1)},[`& + .${rt.inset}`]:{marginLeft:52},[`& .${ot.root}`]:{marginTop:0,marginBottom:0},[`& .${ot.inset}`]:{paddingLeft:36},[`& .${it.root}`]:{minWidth:36}},!e.dense&&{[n.breakpoints.up("sm")]:{minHeight:"auto"}},e.dense&&ce({minHeight:32,paddingTop:4,paddingBottom:4},n.typography.body2,{[`& .${it.root} svg`]:{fontSize:"1.25rem"}}))),Yn=I.forwardRef(function(e,t){const r=un({props:e,name:"MuiMenuItem"}),{autoFocus:i=!1,component:o="li",dense:s=!1,divider:a=!1,disableGutters:u=!1,focusVisibleClassName:f,role:h="menuitem",tabIndex:p,className:g}=r,T=cn(r,Kn),b=I.useContext(tt),k=I.useMemo(()=>({dense:s||b.dense||!1,disableGutters:u}),[b.dense,s,u]),E=I.useRef(null);ln(()=>{i&&E.current&&E.current.focus()},[i]);const C=ce({},r,{dense:k.dense,divider:a,disableGutters:u}),F=Jn(r),U=dn(E,t);let G;return r.disabled||(G=p!==void 0?p:-1),d.jsx(tt.Provider,{value:k,children:d.jsx($n,ce({ref:U,role:h,tabIndex:G,component:o,focusVisibleClassName:Je(F.focusVisible,f),className:Je(F.root,g)},T,{ownerState:C,classes:F}))})}),Xn=Yn,st=({options:n,setValue:e,label:t,gender:r})=>{const[i,o]=I.useState(r),s=a=>{o(a.target.value)};return I.useEffect(()=>{e(i)},[i]),I.useEffect(()=>{o(r)},[r]),d.jsx(xn,{size:"small",variant:"standard",id:t,labelId:t,value:i,onChange:s,label:t,displayEmpty:!0,children:n.map(a=>d.jsx(Xn,{value:a.value,children:a.label},a.value))})};var at="__sak";function bt(){var n;return n={},n["dependent-sdk-initialized-before-auth"]="Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK.",n}var Qn=bt,be=new Pe("auth","Firebase",bt());/**
 * @license
 ...
 */var X=new In("@firebase/auth");function Zn(n){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];X.logLevel<=kt.WARN&&X.warn.apply(X,A(["Auth (".concat(Se,"): ").concat(n)],e,!1))}function pe(n){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];X.logLevel<=kt.ERROR&&X.error.apply(X,A(["Auth (".concat(Se,"): ").concat(n)],e,!1))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nr(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(tr()||yn()||"connection"in navigator)?navigator.onLine:!0}function rr(){if(typeof navigator>"u")return null;var n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ir=function(){function n(e,t){this.shortDelay=e,this.longDelay=t,Q(t>e,"Short delay should be less than long delay!"),this.isMobile=fn()||pn()}return n.prototype.get=function(){return nr()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)},n}();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
